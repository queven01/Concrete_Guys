...
?>
<section <?php echo 'id="'.$section_id.'"'?> class="column content-only <?php if($margin){echo 'margin-'.$margin;}?> <?php if($padding){echo 'padding-'.$padding;}?> <?php if($dark_mode){echo 'dark-mode';} ?>">
    <div class="container">
